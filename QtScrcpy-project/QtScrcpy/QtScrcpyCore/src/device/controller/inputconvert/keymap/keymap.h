...
public:
    ...
    struct KeyMapNode
    {
        ...
        union DATA
        {
            ...
            struct
            {
                ...
                double maxOffsetX = 0.0;
                double maxOffsetY = 0.0;
                int recenterDelayMs = 0;
                int dualTouchMode = 0; // 0=none, 1=clean, 2=delayed, 3=overlap
                KeyNode smallEyes;
            } mouseMove;
            struct
            {
    ...
    const QVector<ExtraEye>& getExtraEyes() const { return m_extraEyes; }
